...
export class BordfintndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"3WM FINANCEMENT TND","id":"",
  "nature":"FINANCEMENT","natureRaff":"TND","reference":"BOF/3WM-FINANCEMENT/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="3WM FINANCEMENT TND" )
