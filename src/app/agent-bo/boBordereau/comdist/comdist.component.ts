...
export class ComdistComponent implements OnInit {

  Factures3wmTnd:any[]=[];
  firstn:any;
  Bordereaux:any[];
  Bordereaux3wmTnd:any[]=[];
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"COMMISSION & DISTRIBUTION","id":"",
  "nature":"COMMISSION","natureRaff":"","reference":"BOF/COMMISSION & DISTRIBUTION/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="COMMISSION & DISTRIBUTION" )
