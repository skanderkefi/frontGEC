...
export class BordchsoctndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"CHARGE LOCALE TND","id":"",
  "nature":"CHARGE LOCALE","natureRaff":"TND","reference":"BOF/CHARGE LOCALE TND/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="CHARGE LOCALE TND" )
