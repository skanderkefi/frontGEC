...
export class BordchsocdeviseComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"CHARGE LOCALE DEVISE","id":"",
  "nature":"CHARGE LOCALE","natureRaff":"DEVISE","reference":"BOF/CHARGE LOCALE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="CHARGE LOCALE DEVISE" )
