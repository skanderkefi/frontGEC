...
export class BordpittndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"PAIEMENT IMPÔTS ET TAXES TND","id":"",
  "nature":"PAIEMENT IMPÔTS ET TAXES","natureRaff":"TND","reference":"BOF/FISCALITÉ-PAIEMENT IMPÔTS ET TAXES/","sentAt":"","sentBy":"",
