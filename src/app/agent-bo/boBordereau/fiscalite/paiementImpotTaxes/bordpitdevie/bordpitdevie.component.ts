...
export class BordpitdevieComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"PAIEMENT IMPÔTS ET TAXES DEVISE","id":"",
  "nature":"PAIEMENT IMPÔTS ET TAXES","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-PAIEMENT IMPÔTS ET TAXES-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="PAIEMENT IMPÔTS ET TAXES" )
