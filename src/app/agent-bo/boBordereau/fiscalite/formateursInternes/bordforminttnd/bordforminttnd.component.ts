...
export class BordforminttndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FORMATEURS INTERNES TND","id":"",
  "nature":"FORMATEURS INTERNES","natureRaff":"TND","reference":"BOF/FORMATEURS INTERNES/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FORMATEURS INTERNES TND" )
