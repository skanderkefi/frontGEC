...
export class BordretsaldeviseComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ RETENU SALAIRE DEVISE","id":"",
  "nature":"FISCALITÉ RETENU SALAIRE","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-RETENUE SALAIRE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ RETENU SALAIRE DEVISE" )
