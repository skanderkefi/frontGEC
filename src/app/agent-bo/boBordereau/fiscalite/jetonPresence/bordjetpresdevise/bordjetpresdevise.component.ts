...
export class BordjetpresdeviseComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"FISCALITÉ - JETON DE PRÉSENCE - DEVISE","id":"",
  "nature":"FISCALITÉ - JETON DE PRÉSENCE","natureRaff":"DEVISE","reference":"BOF/FISCALITÉ-JETON DE PRÉSENCE-DEVISE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="FISCALITÉ - JETON DE PRÉSENCE - DEVISE" )
