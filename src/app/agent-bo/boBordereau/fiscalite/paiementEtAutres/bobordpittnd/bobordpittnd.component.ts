...
export class BobordpeatndComponent implements OnInit {
  ...
  bordereauToCreate={"createdAt":Date.now(),"createdBy":"4125","folder":"PAIEMENT ET AUTRE TND","id":"",
  "nature":"PAIEMENT ET AUTRE","natureRaff":"TND","reference":"BOF/FISCALTÉ-PAIEMENT ET AUTRE/","sentAt":"","sentBy":"",
  ...
  showBordereaux(){
    this.dataService.showBordereau3wm().subscribe((data: any[])=>{
      ...
      for(let i=0; i<data.length; i++){
        if(data[i].folder=="PAIEMENT ET AUTRE TND" )
